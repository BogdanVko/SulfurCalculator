...
<!--- ********************************************************* --->
<!--- New 10/2020 acrump        USEFUL FILE WITH SOLUTION OLEG                                --->
<!--- Verify a body weight etc. was entered from sulfurcalc.cfm --->
<!--- ********************************************************* --->

<CFIF FORM.BODYWEIGHT EQ "" OR FORM.BODYWEIGHT EQ "0" OR NOT isNumeric(Form.BODYWEIGHT)
	  OR form.SulfateWater EQ "" OR NOT isNumeric(Form.SulfateWater)
	  OR form.dmi1 EQ "">
...
<table width="80%" align="center">
 		...
 		<tr>
		   <td>
		   <cfif (Form.BODYWEIGHT EQ "NO") OR (isNumeric(Form.BODYWEIGHT) IS False) OR (FORM.BODYWEIGHT EQ "")>
 			 	Sorry, ANIMAL BODY WEIGHT IN POUNDS is missing or is not numeric.  <br><br>
 			 	<!---  Please click <A HREF="../../webdocs/tools/sulfurcalc.cfm">here</a> to re-enter your information, or --->
 			 	Go "BACK" and correct your information.<br><br>
		   </cfif>
		   <cfif form.SulfateWater EQ "" OR NOT isNumeric(Form.SulfateWater)>
		    	 Sorry, SULFATE IN WATER, ppm is missing or is not numeric. <br><br>
		    	 <!---Please click <A HREF="../../webdocs/tools/sulfurcalc.cfm">here</a> to re-enter your information, or --->
		    	 Go "BACK" and correct your information.<br><br>
		   </cfif>
		   <cfif form.dmi1 EQ "">
		   		Sorry, PERCENT OF TOTAL FEED/FORAGE INTAKE is missing.<br><br>
		   		Go "BACK" and correct your information.<br><br>
		   </cfif>
			<!---
...
<!--- Body weight, sulfate water etc. was entered from sulfurcalc.cfm --->
<cfelse>
...
</CFIF>  <!--- check for missing form ariales --->
